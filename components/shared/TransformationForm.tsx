...
const TransformationForm = ({ action, data = null, type, creditBalance, config = null, userId }: TransformationFormProps) => {
  ...
  const onInputChangeHandler = (fieldName: string, value:string, type: string, onChangeField: (value: string) => void) => {
    debounce(() => {
      setNewTransformation((prevState: any) => ({...prevState, [type]: {
        ...prevState?.[type],
